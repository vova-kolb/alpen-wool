    ...
    if (error || !product) {
        return (
            <main className="container mx-auto min-h-screen py-12 text-center">
                <h1 className="mb-4 text-3xl font-semibold text-alp-text">
        ...
        <main className="container mx-auto py-12 mt-20">
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <p className="text-base leading-relaxed text-white/80">{product.short}</p>

                    {(product.material || product.size || product.weight) && (
                        <div className="space-y-3 rounded-xl border border-white/10 bg-white/5 p-4">
                            <h3 className="text-sm font-semibold uppercase tracking-wide text-alp-accent">Product Details</h3>
                            {product.material && (
                    ...
                    <div className="mt-auto flex flex-col gap-3">
                        {product.isAvailable !== false ? (
                            ...
                            <div className="rounded-xl border border-white/10 bg-white/5 px-6 py-4 text-center text-sm text-white/60">Currently Unavailable</div>
                        )}
                        <Link
                            href="/"
